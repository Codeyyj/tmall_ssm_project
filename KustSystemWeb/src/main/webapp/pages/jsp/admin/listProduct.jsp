...
<%--                            &lt;%&ndash;<c:if test="${!empty p.firstProductImage}">&ndash;%&gt;--%>
<%--                            &lt;%&ndash;<img width="40px" src="img/productSingle/${p.firstProductImage.id}.jpg">&ndash;%&gt;--%>
<%--                            &lt;%&ndash;</c:if>&ndash;%&gt;--%>
...
<%--                    传递产品id--%>
                    <td><a href="admin_propertyValue_edit?ptid=${p.id}"><span
